module.exports = (client, message, args, Discord, db, money) => {
    ...
    if (badJob == 3) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Your boss didn't like the work you did, so you left empty handed!`)
            .setColor(colors.red)
        ...
        let level = db.add(`userdata_${message.author.id}.jobs.programmerLvl`, 1)
    }

    let level = db.get(`userdata_${message.author.id}.jobs.programmerLvl`, 1)
    let levelEmbed = new Discord.MessageEmbed()
        .setTitle("Level up!")
        .setDescription(`Congratulations ${message.author.username}, you leveled up to level ${level / 100} as a programmer!`)
