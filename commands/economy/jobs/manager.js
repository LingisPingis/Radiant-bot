module.exports = (client, message, args, Discord, db, money) => {
    ...
    if (badJob == 3) {
        ...
        let level = db.add(`userdata_${message.author.id}.jobs.managerLvl`, 1)
    }

    let level = db.get(`userdata_${message.author.id}.jobs.managerLvl`, 1)
    let levelEmbed = new Discord.MessageEmbed()
        .setTitle("Level up!")
        .setDescription(`Congratulations ${message.author.username}, you leveled up to level ${level / 100} as a manager!`)
